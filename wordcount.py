...
__author__ = "Reggy Tjitradi with David Stewart' guidance + Daniel's and Doug's demo"
...
def print_top(filename):
    ...
    for index, word in enumerate(sorted_items[:20]):
        print(str(index + 1) + ". " + str(word[0]) + " : " + str(word[1]))
